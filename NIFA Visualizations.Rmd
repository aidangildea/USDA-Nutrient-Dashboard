...
prot2 <- plot_ly(
  data = categfull, x = ~price, y = ~densprot, 
          ...
          height = 500,
          hoverinfo = "text",
          text = ~paste0("<b>", categ_name, "</b><br>", "<b><i>Description: </b></i>", categ_des, "<br><b><i>Total Daily Spending: </b></i>", tspend),
    #ifelse(categfull$categ_name == categfull$categ_des, (~paste0("<b>", categ_name, "</b><br>", "<b><i>Description: </b></i>", categ_des, "<br><b><i>Total Daily Spending: </b></i>", tspend)), (~paste0("<b>", categ_name, "</b><br>", "<br><b><i>Total Daily Spending: </b></i>", tspend))),         
          type = "scatter",
          mode = "markers"
          ) %>%
  layout(
    title = list(text = "<b>Price v. Nutrient Density</b>", x = .7),
        ...
        buttons = list(
         list(method = "restyle",
          ...
          list(method = "restyle",
               ...
               label = "Added Sugar(g)/1000kcal"),
          list(method = "restyle",
               args = list("y", list(categfull$denssodi)),
               label = "Sodium(gm)/1000kcal")))))
